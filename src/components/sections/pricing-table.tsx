...
const PricingTable = () => {
  const includes = [
    ...
    { name: 'Armadilhas do IMT (25 pegadinhas)', price: '47,00€' },
  ...
  return (
    <section id="pricing" className="py-20 px-5 bg-[#05070a]">
      <div className="max-w-[1200px] mx-auto text-center">
        ...
        {/* Pricing Card */}
        <div className="max-w-[500px] mx-auto bg-[#0c0f16] border border-[#1e293b] rounded-[24px] p-8 shadow-[0_20px_60px_rgba(0,0,0,0.7)]">
          {/* Price Header */}
          <div className="mb-8">
          ...
          {/* CTA Button */}
          <button className="w-full bg-[#22c55e] hover:shadow-[0_0_20px_rgba(34,197,94,0.4)] transition-all duration-200 text-[#05070a] font-bold py-4 px-6 rounded-full flex items-center justify-center gap-2 text-sm uppercase mb-6 transform hover:-translate-y-0.5">
            GARANTIR MEU ACESSO COM DESCONTO AGORA
