...
export default function ProblemasSolucoes() {
  return (
    <section className="py-20 px-5 md:px-10 bg-[#05070a]">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          {/* Pain Points Card */}
          <div className="bg-[#0c0f16] border border-[#1e293b] rounded-[16px] p-8">
            <h3 className="text-xl font-semibold text-white mb-6 flex items-center gap-2">
              O que mais reprova
            </h3>
            <ul className="space-y-5">
              <li className="flex items-start gap-3">
                <AlertTriangle className="text-[#facc15] w-5 h-5 mt-1 flex-shrink-0" />
                <span className="text-[#94a3b8] text-[16px] leading-relaxed">
          ...
          <div className="bg-[#0c0f16] border border-[#1e293b] rounded-[16px] p-8">
            ...
            <ul className="space-y-5">
              <li className="flex items-start gap-3">
                <CheckCircle2 className="text-[#22c55e] w-5 h-5 mt-1 flex-shrink-0" />
                <span className="text-[#94a3b8] text-[16px] leading-relaxed">
